...
class LightSensorTest(unittest.TestCase):
    ...
    def check_values(self, lf, ls, rs, rf):
        ...
        self.assertEqual(vs.left_side, ls, "different value: left side")
        self.assertEqual(vs.right_side, rs, "different value: right side")
        self.assertEqual(vs.right_forward, rf, "different value: right forward")
